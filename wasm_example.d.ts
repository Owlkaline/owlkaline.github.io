...
export interface InitOutput {
  ...
  readonly wasm_bindgen__convert__closures__invoke0_mut__h1dcdcd48a36e1387: (a: number, b: number) => void;
  readonly wasm_bindgen__convert__closures__invoke1_mut__h116069977673858b: (a: number, b: number, c: number) => void;
  readonly wasm_bindgen__convert__closures__invoke2_mut__h8d2a2b85ad358154: (a: number, b: number, c: number, d: number) => void;
  readonly wasm_bindgen__convert__closures__invoke1_mut__h01f55c2699557cc7: (a: number, b: number, c: number) => void;
  readonly wasm_bindgen__convert__closures__invoke0_mut__h5be853b29c1058d0: (a: number, b: number) => void;
  readonly wasm_bindgen__convert__closures__invoke0_mut__ha3904c9b271649d8: (a: number, b: number) => void;
  readonly _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h20cc5a6050a04fa6: (a: number, b: number, c: number) => void;
